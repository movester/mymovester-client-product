...
})(["width:100%;:hover{cursor:pointer;}:hover img{transition:transform 0.2s ease-in-out;transform:scale(1.2);opacity:0.7;}"]);
...
/* harmony import */ var movester_design_system__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(2531);
...
/* harmony import */ var react_intersection_observer__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(4009);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(5893);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_components_utils_Navigator__WEBPACK_IMPORTED_MODULE_1__, _hooks_api_useStretchingInquiry__WEBPACK_IMPORTED_MODULE_8__, react_intersection_observer__WEBPACK_IMPORTED_MODULE_12__]);
([_components_utils_Navigator__WEBPACK_IMPORTED_MODULE_1__, _hooks_api_useStretchingInquiry__WEBPACK_IMPORTED_MODULE_8__, react_intersection_observer__WEBPACK_IMPORTED_MODULE_12__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const StrechingPage = ({
  ...
  const {
    ref,
    inView
  } = (0,react_intersection_observer__WEBPACK_IMPORTED_MODULE_12__.useInView)({
    threshold: 0.5,
    delay: 0
  });
  (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(PageWrapper, {
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx(_components_utils_Navigator__WEBPACK_IMPORTED_MODULE_1__/* .MemorizedNavigator */ .y, {
      ...
      $ismobile: ismobile,
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(movester_design_system__WEBPACK_IMPORTED_MODULE_11__.Box, {
        display: "flex",
        flexDirection: "column",
        justifyContent: "start",
        alignItems: "center",
        ...
        }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx(movester_design_system__WEBPACK_IMPORTED_MODULE_11__.Box, {
          display: "flex",
          flexDirection: "row",
      ...
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(movester_design_system__WEBPACK_IMPORTED_MODULE_11__.Box, {
        display: "flex",
        flexDirection: "column",
        justifyContent: "center",
        alignItems: "center",
        gap: 16,
        children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx(movester_design_system__WEBPACK_IMPORTED_MODULE_11__.Box, {
          display: "flex",
          flexDirection: "column",
          justifyContent: "start",
          alignItems: "start",
          width: "100%",
          children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx(movester_design_system__WEBPACK_IMPORTED_MODULE_11__.ComboBox, {
            size: "xs",
            list: _constants__WEBPACK_IMPORTED_MODULE_4__/* .LIST_ORDER_CATEGORY */ .a9,
            value: listOrder,
            setValue: setListOreder
          })
        }), data && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx(ItemGrid, {
...
})(["max-width:900px;display:grid;grid-template-columns:repeat(4,1fr);gap:16px;@media screen and (max-width:900px){grid-template-columns:repeat(3,1fr);}@media screen and (max-width:560px){grid-template-columns:repeat(1,1fr);}"]);
