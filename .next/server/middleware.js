...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2FUsers_2Fkimheejin_2FDocuments_2Fmymovester_projects_2Fmymovester_client_product_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
var _edge_runtime_cookies = __webpack_require__(792);
...
function constants_objectSpread(target) {
    for(var i = 1; i < arguments.length; i++){
        var source = null != arguments[i] ? arguments[i] : {};
        i % 2 ? constants_ownKeys(Object(source), !0).forEach(function(key) {
            constants_defineProperty(target, key, source[key]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : constants_ownKeys(Object(source)).forEach(function(key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
        });
    }
    return target;
...
const INSTRUMENTATION_HOOK_FILENAME = "instrumentation"; // Because on Windows absolute paths in the generated code can break because of numbers, eg 1 in the path,
...
const WEBPACK_LAYERS = constants_objectSpread(constants_objectSpread({}, WEBPACK_LAYERS_NAMES), {}, {
    GROUP: {
        server: [
...
function api_utils_ownKeys(object, enumerableOnly) {
    var keys = Object.keys(object);
    if (Object.getOwnPropertySymbols) {
        var symbols = Object.getOwnPropertySymbols(object);
        enumerableOnly && (symbols = symbols.filter(function(sym) {
...
function api_utils_objectSpread(target) {
    for(var i = 1; i < arguments.length; i++){
        var source = null != arguments[i] ? arguments[i] : {};
        i % 2 ? api_utils_ownKeys(Object(source), !0).forEach(function(key) {
            api_utils_defineProperty(target, key, source[key]);
        }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : api_utils_ownKeys(Object(source)).forEach(function(key) {
            Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));
        });
    }
    return target;
}
function api_utils_defineProperty(obj, key, value) {
    if (key in obj) {
        Object.defineProperty(obj, key, {
            value: value,
            enumerable: true,
 ...
 */ function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(296);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(296);
    const previous = res.getHeader("Set-Cookie");
    res.setHeader(`Set-Cookie`, [
        ...typeof previous === "string" ? [
            previous
        ] : Array.isArray(previous) ? previous : [],
        serialize(COOKIE_NAME_PRERENDER_BYPASS, "", api_utils_objectSpread({
        ...
        serialize(COOKIE_NAME_PRERENDER_DATA, "", api_utils_objectSpread({
            // To delete a cookie, set `expires` to a date in the past:
            // https://tools.ietf.org/html/rfc6265#section-4.1.1
            // `Max-Age: 0` is not valid, thus ignored, and the cookie is persisted.
            expires: new Date(0),
 ...
 */ function setLazyProp({ req }, prop, getter) {
    ...
    const optsReset = api_utils_objectSpread(api_utils_objectSpread({}, opts), {}, {
        writable: true
    });
    Object.defineProperty(req, prop, api_utils_objectSpread(api_utils_objectSpread({}, opts), {}, {
        get: ()=>{
            const value = getter(); // we set the property on the object to avoid recalculating it
            Object.defineProperty(req, prop, api_utils_objectSpread(api_utils_objectSpread({}, optsReset), {}, {
                value
            }));
            return value;
        },
...
const requestAsyncStorage = createAsyncLocalStorage();
...
async function adapter(params) {
  ...
  */ if (isDataReq) {
    ...
    let response;
    let cookiesFromResponse; // we only care to make async storage available for middleware
...
;// CONCATENATED MODULE: ./hooks/utils/manage-token.ts
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2FUsers%2Fkimheejin%2FDocuments%2Fmymovester-projects%2Fmymovester-client-product&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2FUsers_2Fkimheejin_2FDocuments_2Fmymovester_projects_2Fmymovester_client_product_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/middleware",
            handler,
